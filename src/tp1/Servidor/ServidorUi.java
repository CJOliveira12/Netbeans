...
public class ServidorUi extends javax.swing.JFrame {
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        try {
            if (servidor == null) {
                servidor = new Servidor(Integer.parseInt(jTextField1.getText())); // so envia a porta
            }
            ...
            jTextField3.setText(servidor.isEstado() ? "Ligado" : "Desligado");
            jToggleButton1.setSelected(servidor.isEstado());
        } catch (IOException | NumberFormatException ex) {
            System.out.println(ex.getMessage()); // imprime a mensagem de excepção.
        }
        // imprime a mensagem de excepção.
